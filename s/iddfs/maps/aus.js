	...
	var aus = {
		nodes:{
			Adelaide: {'color':notVisited,'shape':'dot','label':'Adelaide'},
			Sydney: {'color':notVisited,'shape':'dot','label':'Sydney' },
			BlackStump: {'color':notVisited,'shape':'dot','label':'Black Stump'},
			Brisbane: {'color':notVisited,'shape':'dot','label':'Brisbane'},
			Canberra: {'color':notVisited,'shape':'dot','label':'Canberra'},
			Darwin: {'color':notVisited,'shape':'dot','label':'Darwin'},
			Hobart: {'color':notVisited,'shape':'dot','label':'Hobart'},			
			Melbourne: {'color':notVisited,'shape':'dot','label':'Melbourne'},
			Perth: {'color':notVisited,'shape':'dot','label':'Perth'}
		},
		edges:{
			Sydney: { Brisbane:{}, Canberra:{}, Melbourne:{} },
			Canberra: { Sydney:{}, Adelaide:{}, Darwin:{}, Melbourne:{} },
			Adelaide: { Canberra:{}, Melbourne:{}, Perth:{} },
			BlackStump: { Darwin:{} },
			Darwin: { Canberra:{}, BlackStump:{} },
			Brisbane: { Sydney:{} },
			Melbourne: { Sydney:{}, Canberra:{}, Adelaide:{}, Hobart:{} },
			Hobart: { Melbourne:{} },
			Perth: { Adelaide:{} }
		}
	};	
	...
	// Executing draw on canvas with map
	sys.graft(aus);
