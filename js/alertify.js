	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				ok     : "<a href=../../form/js//\"#//\" class=\"alertify-button alertify-button-ok\" id=\"aOK\">{{ok}}</a>",
				cancel : "<a href=../../form/js//\"#//\" class=\"alertify-button alertify-button-cancel\" id=\"aCancel\">{{cancel}}</a>"
			},
